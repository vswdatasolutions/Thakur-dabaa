...
const RoomDetailDrawer: React.FC<RoomDetailDrawerProps> = ({ isOpen, onClose, room, onUpdateStatus, onEditRoom, onDeleteRoom }) => {
  ...
  return (
    ...
    >
      ...
      {/* Drawer Content */}
      <div className="absolute right-0 top-0 h-full w-full md:w-3/4 lg:w-1/2 xl:w-1/3 bg-white dark:bg-[#3B5974] shadow-2xl p-6 md:p-8 flex flex-col overflow-y-auto">
        <div className="flex justify-between items-center pb-4 border-b border-gray-200 dark:border-[#2A3C4C] mb-6">
          <h2 className="text-4xl font-extrabold text-gray-900 dark:text-[#F5F0E1]">Room {room.roomNumber}</h2>
        ...
        <div className="flex-grow space-y-6 text-xl text-gray-800 dark:text-[#F5F0E1]">
          ...
          {loading ? (
            ...
            <>
              <h3 className="text-3xl font-bold text-gray-900 dark:text-[#F5F0E1] mt-8 mb-4 border-t pt-4 border-gray-200 dark:border-[#2A3C4C]">Current Booking Details</h3>
              {currentBooking ? (
                <div className="space-y-4">
                  ...
                  {guestInfo && (
                    <>
                      <h4 className="text-2xl font-bold text-gray-900 dark:text-[#F5F0E1] mt-6 mb-3 border-t pt-3 border-gray-200 dark:border-[#2A3C4C]">Guest Information</h4>
                      ...
                      {guestInfo.kycDocumentUrl && (
                        <div>
                          ...
                          <a
                            ...
                            className="text-blue-600 hover:underline dark:text-[#5C86AA]"
                          >
                            View Document
                          </a>
                        </div>
                ...
                <p className="text-lg italic text-gray-600 dark:text-[#C7C0B0]">No active booking for this room.</p>
              )}
            </>
          )}
        </div>
        ...
        {/* Action Buttons */}
        <div className="flex flex-col gap-4 mt-8 pt-6 border-t border-gray-200 dark:border-[#2A3C4C] sticky bottom-0 bg-white dark:bg-[#3B5974]">
